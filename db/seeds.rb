...
# DailyQuote.find_or_create_by(date: '2024-04-02', quote: "There go the Goddamn brownies!", watch_title_id: burbs.id)
# DailyQuote.find_or_create_by(date: '2024-04-03', quote: "Father! The sleeper has awakened!", watch_title_id: dune84.id)